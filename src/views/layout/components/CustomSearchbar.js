...
import CustomAutocomplete from "../../../components/CustomComponents/CustomComponents";

// ** Configs Imports

import { Icon } from "@iconify/react";
// import propertyContext from "../../contexts/propertyContext";
// import cmsDashboardPaths from "../../routes/paths/cmsDashboardPaths";
...
const AutocompleteComponent = ({ hidden, settings }) => {
  ...
  //   useEffect(() => {
  //     const filteredData = searchData?.filter((obj) =>
  //       obj.title.toLowerCase().includes(searchValue.toLowerCase())
  //     );
  //     const slicedData = filteredData?.slice(0, 15);
  ...
  if (!isMounted) {
    ...
    return (
      ...
      >
        ...
        >
          <Icon icon="heroicons:magnifying-glass-16-solid" fontSize={30} />
        </IconButton>
...
!important`,
                      ...
                      >
                        <Icon icon={option.icon || theme.navSubItemIcon} />
